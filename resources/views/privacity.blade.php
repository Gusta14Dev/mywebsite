...
@section('content')
    ...
    <section>
        ...
        <p>A sua privacidade é importante para nós. É política do Dorsem respeitar a sua privacidade em relação a qualquer
            informação sua que possamos coletar no site <a href=http://dorsem.documentoemordem.com.br>Dorsem</a>, e outros
        ...
        <h2>Política de Cookies Dorsem</h2>
        ...
        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Dorsem oferece no site e com
        ...
        <ul>
            ...
            <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, <a
                    ...
                    href='https://ondeapostar.pt/onde-da-a-bola/'>Onde dá a Bola</a> ou azar, qualquer tipo de pornografia
                ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
            <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Dorsem, de seus fornecedores
