<form class="w-11/12 lg:skew-x-6 lg:w-4/5 " wire:submit.prevent="submit" method="post">
    ...
    <div class="relative mt-6">
        <input required id="nome" name="nome" wire:model.defer="nome" type="text" class="peer h-10 w-full text-gray-900 placeholder-transparent focus:outline-none rounded px-2" placeholder="Rogerio Doutri" />
    ...
    <div class="relative mt-6">
        <input required id="email" name="email" wire:model.defer="email" type="email" class="peer h-10 w-full text-gray-900 placeholder-transparent focus:outline-none rounded px-2" placeholder="contato@dorsem.com.br" />
    ...
    <div class="relative mt-6">
        <input required id="tel" name="celular" wire:model.defer="celular" type="tel" class="peer h-10 w-full text-gray-900 placeholder-transparent focus:outline-none rounded px-2 phone" placeholder="(13) 982473824" />
    ...
    <div class="relative mt-8">
        <textarea required id="explicacao" name="explicacao" wire:model.defer="explicacao" class="peer w-full text-gray-900 placeholder-transparent focus:outline-none rounded px-2" rows="3"></textarea>
    ...
    <div class="flex items-start mt-2 mr-4 mb-2">
        <input required type="checkbox" id="confirm" name="confirm" wire:model.defer="confirm" class="opacity-0 absolute h-8 w-8" />
