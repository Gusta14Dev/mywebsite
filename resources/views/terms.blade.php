...
@section('content')
    ...
    <section>
        <h2>1. Termos</h2>
        <p>Ao acessar ao site <a href='http://dorsem.documentoemordem.com.br'>Dorsem</a>, concorda em cumprir estes termos
        ...
        <p>É concedida permissão para baixar temporariamente uma cópia dos materiais (informações ou software) no site
            Dorsem , apenas para visualização transitória pessoal e não comercial. Esta é a concessão de uma licença, não
        ...
        <ol>
            ...
            <li>tentar descompilar ou fazer engenharia reversa de qualquer software contido no site Dorsem;  </li>
        ...
        <p>Esta licença será automaticamente rescindida se você violar alguma dessas restrições e poderá ser rescindida por
            Dorsem a qualquer momento. Ao encerrar a visualização desses materiais ou após o término desta licença, você
            deve apagar todos os materiais baixados em sua posse, seja em formato eletrónico ou impresso.</p>
        <h2>3. Isenção de responsabilidade</h2>
        <ol>
            <li>Os materiais no site da Dorsem são fornecidos 'como estão'. Dorsem não oferece garantias, expressas ou
            ...
            <li>Além disso, o Dorsem não garante ou faz qualquer representação relativa à precisão, aos resultados prováveis
        ...
        <h2>4. Limitações</h2>
        <p>Em nenhum caso o Dorsem ou seus fornecedores serão responsáveis ​​por quaisquer danos (incluindo, sem limitação,
            danos por perda de dados ou lucro ou devido a interrupção dos negócios) decorrentes do uso ou da incapacidade de
            usar os materiais em Dorsem, mesmo que Dorsem ou um representante autorizado da Dorsem tenha sido notificado
        ...
        <p>Os materiais exibidos no site da Dorsem podem incluir erros técnicos, tipográficos ou fotográficos. Dorsem não
            garante que qualquer material em seu site seja preciso, completo ou atual. Dorsem pode fazer alterações nos
            materiais contidos em seu site a qualquer momento, sem aviso prévio. No entanto, Dorsem não se compromete a
            atualizar os materiais.</p>
        <h2>6. Links</h2>
        <p>O Dorsem não analisou todos os sites vinculados ao seu site e não é responsável pelo conteúdo de nenhum site
            vinculado. A inclusão de qualquer link não implica endosso por Dorsem do site. O uso de qualquer site vinculado
            é por conta e risco do usuário.</p>
        </p>
        <h3>Modificações</h3>
        <p>O Dorsem pode revisar estes termos de serviço do site a qualquer momento, sem aviso prévio. Ao usar este site,
            você concorda em ficar vinculado à versão atual desses termos de serviço.</p>
        <h3>Lei aplicável</h3>
        <p>Estes termos e condições são regidos e interpretados de acordo com as leis do Dorsem e você se submete
